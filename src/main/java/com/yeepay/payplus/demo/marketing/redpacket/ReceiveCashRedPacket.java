...
/**
 * 作者: 张腾
 * 日期: 2016年09月05日 上午11:16
 * 描述: 领取现金红包
 */
public class ReceiveCashRedPacket {
    public static final String RECIVE_CASH_RED_PACKET_URI = "/rest/v1.0/user/receiveRedPacket";
    public static void main(String[] args){
        ...
        //参数 begin
        request.addParam("couponNo","HBDY00033301");//	卡券编号
        request.addParam("merchantNo",Config.MERCHANTNO);//	发券方商户编号
        request.addParam("merchantUserId",Config.MERCHANT_USER_ID);//	领券方商户用户标识
        //参数 end
        YopResponse response = YopClient.post(RECIVE_CASH_RED_PACKET_URI, request);//发送报文
