...
public class Recharge {
    ...
    public static void main(String[] args) {
        ...
        //参数 begin
        request.addParam("requestNo", 12312344);//商户请求号，投产时请不要使用时间戳，避免并发重复
        request.addParam("merchantNo", Config.MERCHANTNO);//商户编号
        request.addParam("merchantUserId", Config.MERCHANT_USER_ID);//商户用户标识R
        ...
        //request.addParam("bindCardId", "45635514");//指定支付方式如果是绑卡BINDCARD bindCardId必须为空
